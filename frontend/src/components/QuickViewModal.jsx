  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="quickview-grid" style={{ display: 'grid', gap: 0 }}>
          {/* Image */}
          <div className="quickview-img" style={{ background: 'var(--bg-page)', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
